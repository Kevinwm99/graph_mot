...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--load_model', default='/home/kevinwm99/MOT/FairMOT/models/ctdet_coco_dla_2x.pth',
        ...
        # system
        self.parser.add_argument('--gpus', default='8,9',
        ...
        self.parser.add_argument('--data_dir', type=str, default='/home/kevinwm99/MOT/FairMOT/data/MOT2017')
