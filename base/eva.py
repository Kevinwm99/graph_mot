...
def parse_arguments():
    ...
    parser.add_argument('--gt_path',default='/home/kevinwm99/MOT/mot_neural_solver/data/MOT_eval_gt/',
                        type=str, help='', required=True)
    parser.add_argument('--out_mot_files_path', default='/home/kevinwm99/MOT/GCN/base/result/',
                        type=str, help='', required=True)
